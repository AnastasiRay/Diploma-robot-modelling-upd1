...
class OpenWindow(QMainWindow):
    __data = {
        ...
        'coord_cil': [-1.5, 1.5, 0.0, 0.7, 0.0, 0.0],
        'param_scr': [1.5, 0.1, 0.6, 0.4, 0.2, 10.0, 6.0],
        'coord_scr': [-1.5, 1.5, -2.5, 2.5, 0.1, 0.4],
        'param_col': [1.5, 0.1, 0.4, 0.2, 10.0, 6.0],
        'coord_col': [0.0, 0.3, -2.5, 2.5, 0.0, 0.0],
        ...
        'line_or_circle': 'line',
        'ciclogram1': [np.linspace(0.5, 8, 16),
    ...
    def show4_select_coord_cil(self, checked):
        ...
        input5_coord_cil = QDoubleSpinBox(decimals=3, singleStep=0.001, maximum=1, minimum=0, value=coord_cil[4])
        input5_coord_cil.valueChanged.connect(lambda change: self.show4_change_coord_cil(change, 4))
        input6_coord_cil = QDoubleSpinBox(decimals=3, singleStep=0.001, maximum=1, minimum=0, value=coord_cil[5])
        ...
        grid4_coord_cil.addWidget(label4_coord_cil, 2, 0)
        grid4_coord_cil.addWidget(label5_coord_cil, 2, 1)
        grid4_coord_cil.addWidget(label6_coord_cil, 2, 2)
        grid4_coord_cil.addWidget(input4_coord_cil, 3, 0)
        grid4_coord_cil.addWidget(input5_coord_cil, 3, 1)
        grid4_coord_cil.addWidget(input6_coord_cil, 3, 2)
    ...
    def show4_select_coord_scr(self, checked):
        ...
        input5_coord_scr = QDoubleSpinBox(decimals=3, singleStep=0.001, maximum=1, minimum=0, value=coord_scr[4])
        input5_coord_scr.valueChanged.connect(lambda change: self.show4_change_coord_scr(change, 4))
        input6_coord_scr = QDoubleSpinBox(decimals=3, singleStep=0.001, maximum=1, minimum=0, value=coord_scr[5])
        ...
        grid4_coord_scr.addWidget(label4_coord_scr, 2, 0)
        grid4_coord_scr.addWidget(label5_coord_scr, 2, 1)
        grid4_coord_scr.addWidget(label6_coord_scr, 2, 2)
        grid4_coord_scr.addWidget(input4_coord_scr, 3, 0)
        grid4_coord_scr.addWidget(input5_coord_scr, 3, 1)
        grid4_coord_scr.addWidget(input6_coord_scr, 3, 2)
    ...
    def show4_select_coord_col(self, checked):
        ...
        input5_coord_col = QDoubleSpinBox(decimals=3, singleStep=0.001, maximum=1, minimum=0, value=coord_col[4])
        input5_coord_col.valueChanged.connect(lambda change: self.show4_change_coord_col(change, 4))
        input6_coord_col = QDoubleSpinBox(decimals=3, singleStep=0.001, maximum=1, minimum=0, value=coord_col[5])
        input6_coord_col.valueChanged.connect(lambda change: self.show4_change_coord_col(change, 5))
        ...
        grid4_coord_col.addWidget(label4_coord_col, 2, 0)
        grid4_coord_col.addWidget(label5_coord_col, 2, 1)
        grid4_coord_col.addWidget(label6_coord_col, 2, 2)
        grid4_coord_col.addWidget(input4_coord_col, 3, 0)
        grid4_coord_col.addWidget(input5_coord_col, 3, 1)
        grid4_coord_col.addWidget(input6_coord_col, 3, 2)
    ...
    def show4_select_cont_line(self, checked):
        ...
        show_graph_line.clicked.connect(self.show5_workspace)
    ...
    def show4_select_cont_circle(self, checked):
        ...
        show_graph_circle.clicked.connect(self.show5_workspace)
    ...
    #РАБОЧАЯ ОБЛАСТЬ ЦИЛИНДР--------------------------------------------------------------------------------------------
            ...
            const1 = 0.62
            const2 = 1.78
            q_min, q_max = self.data['coord_cil'][0:2]
            a_min, a_max = self.data['coord_cil'][2:4]
            a_min = (const2 - const1) * a_min + const1
            a_max = (const2 - const1) * a_max + const1
            y_min = np.arange(0.0, a_min + 0.001, 0.001)
            y_max = np.arange(0.0, a_max + 0.001, 0.001)
            xmin = (a_min ** 2 - y_min ** 2) ** 0.5
            x = (a_max ** 2 - y_max ** 2) ** 0.5

            circle__x_array = np.nan_to_num(
                np.concatenate((x, -x[::-1], -xmin, xmin[::-1]))
            )
            circle__y_array = np.nan_to_num(
                np.concatenate((y_max, y_max[::-1], y_min, y_min[::-1]))
            )
